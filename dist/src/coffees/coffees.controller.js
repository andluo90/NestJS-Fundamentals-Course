...
let CoffeesController = class CoffeesController {
    ...
    findAll(request, paginationQuery) {
        return this.coffeesService.findAll(request[iam_constants_1.REQUEST_USER_KEY].sub, paginationQuery);
    }
    findOne(id) {
        return this.coffeesService.findOne(id);
    }
    create(request, createCoffeeDto) {
        return this.coffeesService.create(request[iam_constants_1.REQUEST_USER_KEY].sub, createCoffeeDto);
    }
    update(request, id, updateCoffeeDto) {
        return this.coffeesService.update(request[iam_constants_1.REQUEST_USER_KEY].sub, id, updateCoffeeDto);
    }
    remove(id) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, create_coffee_dto_1.CreateCoffeeDto]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Number, update_coffee_dto_1.UpdateCoffeeDto]),
    __metadata("design:returntype", void 0)
